...
const routes = [{ path: 'home', component: _home_component__WEBPACK_IMPORTED_MODULE_1__["HomeComponent"] }];
...
const routes = [{ path: '', loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./home/home.module */ "ct+p")).then(m => m.HomeModule) }, { path: 'bingo', loadChildren: () => __webpack_require__.e(/*! import() | bingo-bingo-module */ "bingo-bingo-module").then(__webpack_require__.bind(null, /*! ./bingo/bingo.module */ "a1Fe")).then(m => m.BingoModule) }];
